...
class NavigationThemeNode extends \Twig_Node {
    ...
    public function __construct(\Twig_NodeInterface $navigation, \Twig_NodeInterface $resources, $lineNumber, $tag = null) {
    ...
    public function compile(\Twig_Compiler $compiler) {
        $compiler
            ->addDebugInfo($this)
            ->write('echo $this->env->getExtension(\'webfactory_navigation_twig_extension\')->setTheme(')
